...
<sub><b>Answers</b> · everything the plugin loads at version 1.10.2 · generated, `npm run upkeep` rewrites it · <a href="../README.md">README</a></sub>
...
| What ships | Count |
|---|---|
| Guard logic, agent-affecting only | **1046** lines across 8 flow files |
