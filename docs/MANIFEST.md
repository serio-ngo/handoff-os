...
<sub><b>Answers</b> · everything the plugin loads at version 1.10.1 · generated, `npm run upkeep` rewrites it · <a href="../README.md">README</a></sub>
...
| What ships | Count |
|---|---|
| Guard logic | **1389** lines of Node across 13 scripts |
| Pattern rules | **63** |
